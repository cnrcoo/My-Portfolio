...
const style = {
	...
	header:
		'flex items-center justify-between rounded-t-lg px-6 py-4 dark:bg-[#262a30]',
	...
	priceInfoCantainer: 'space-y-1',
	mediumFont: 'font-medum',
	...
	return (
		<div className={style.wrapper}>
			<div className={style.header}>
				<div className={style.headerContent}>
					...
					<div className={style.greyText}>
						Sales end June 30, 2022 at 8:20px GMT-7
					</div>
				</div>
			...
			<div className={style.mainContainer}>
				<div className={style.priceInfoCantainer}>
