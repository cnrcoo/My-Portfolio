						...
						<div className={style.collectionInfoWrapper}>
							<div className={style.collectionInfoContainer}>
								...
								<div className={style.descriptionContainer}>
									Ninjas yield $NST tokens daily & give access to
									cutting edge daily crypto calls, analysis & news from
									our top tier crypto and NFT experts… Join the squad!
								</div>
							</div>
						</div>
					</div>
