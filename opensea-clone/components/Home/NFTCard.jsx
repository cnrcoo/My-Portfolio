...
const style = {
	wrapper: `relative flex h-[450px] w-[340px] cursor-pointer flex-col rounded-lg shadow-lg
    transition-all duration -300 hover:shadow-2cl dark:bg-[#333333]`,
